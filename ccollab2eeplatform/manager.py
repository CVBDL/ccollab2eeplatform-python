...
class RecordManager:
    ...
    def _save_to_eeplatform(self, setting, schema, data):
    ...
    def _process_count_by_month_from_product(self, product, setting):
        ...
        self._save_to_eeplatform(setting, schema, data)
    ...
    def process_comment_density_changed_by_month_from_product(self):
        ...
        for product, setting in self._settings[name].items():
            self._process_comment_density_changed_by_month_from_product(
                product, setting)
    ...
    def _process_inspection_rate_by_month_from_product(self, product, setting):
    ...
    def process_inspection_rate_by_month_from_product(self):
        ...
        for product, setting in self._settings[name].items():
            self._process_inspection_rate_by_month_from_product(
                product, setting)
