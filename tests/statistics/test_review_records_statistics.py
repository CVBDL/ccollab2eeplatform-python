...
class TestReviewRecordsStatistics(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self._records = [
            ...
            ['5', '2016-12-20 11:55 UTC', 'unknown', '', '0', '0', '0', '0', '0:00:10'],
            ['6', '2016-11-15 11:55 UTC', 'pzhong', '', '0', '0', '0', '0', '0:00:10'],
            ['7', '2016-10-11 11:55 UTC', 'unknown', '', '0', '0', '0', '0', '0:00:10'],
            ['8', '2016-09-09 11:55 UTC', 'trang', '', '0', '0', '0', '0', '0:00:10'],
            ['9', '2016-09-01 11:55 UTC', 'trang', '', '0', '0', '0', '0', '0:00:10']
        ]
    ...
    def test_get_valid_records(self):
        self.assertEqual(len(self.stat._get_valid_records()), 7)
        for record in self.stat._get_valid_records():
            self.assertTrue(record.creator_login in self.login_names)

    def test_calc_review_count_by_month(self):
        schema, data = self.stat.calc_review_count_by_month()
